...
//         <motion.div variants={itemVariants} className="mb-20 max-w-[1220px]">
...
//           <motion.div variants={imageVariants} className="w-full lg:w-[559px] flex-shrink-0">
...
//               <motion.h2 variants={itemVariants} className="font-inter font-medium text-[18px] md:text-[22px] leading-[1.2] md:leading-[60px] text-black">
//                 Why Choose Us
//               </motion.h2>
