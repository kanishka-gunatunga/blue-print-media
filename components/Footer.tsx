...
export default function Footer() {
  return (
    <footer className="relative w-full bg-gradient-to-b from-[#0F0061] to-[#070030] pt-20 pb-8 overflow-hidden font-inter border-t border-white/5">
      ...
      />
      {/* Radial Gradient Glow to enhance grid visibility */}
      <div 
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          {/* Middle Spacer for large screens */}
          ...
          <div className="md:col-span-3 lg:col-span-2 flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {['Home', 'About Us', 'Services', 'About the CEO', 'Testimonials', 'Contact Us'].map((link) => (
                <li key={link}>
                  <Link href="#" className="font-normal text-[16px] leading-[24px] text-[#CECECE] hover:text-white transition-colors">
                    {link}
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-3 lg:col-span-3 flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {['Branding & Design', 'Printing & Production', 'Media & Content Creation'].map((service) => (
                <li key={service}>
                  <Link href="#" className="font-normal text-[16px] leading-[24px] text-[#CECECE] hover:text-white transition-colors">
                    {service}
                  </Link>
